...
public class PickerViewDialog: UIView {
    ...
    func initInterface(){
        ...
        self.pickerView.autoresizingMask = UIView.AutoresizingMask.flexibleRightMargin
    ...
    public func show(title: String, doneButtonTitle: String = "Chọn", cancelButtonTitle: String = "Hủy", callback: @escaping PickerViewCallback) {
        ...
        self.doneButton.setTitle(doneButtonTitle, for: UIControl.State.normal)
        self.cancelButton.setTitle(cancelButtonTitle, for: UIControl.State.normal)
...
//        NotificationCenter.default.addObserver(self, selector: #selector(PickerViewDialog.deviceOrientationDidChange(notification:)), name: NSNotification.Name.UIDevice.orientationDidChangeNotification, object: nil)
//        
        /* Anim */
    ...
    private func addButtonsToView(container: UIView) {
        ...
        self.cancelButton.setTitleColor(UIColor(red: 0, green: 0.5, blue: 1, alpha: 1), for: UIControl.State.normal)
        ...
        self.cancelButton.addTarget(self, action: #selector(PickerViewDialog.buttonTapped(sender:)), for: UIControl.Event.touchUpInside)
        ...
        self.doneButton.setTitleColor(UIColor(red: 0, green: 0.5, blue: 1, alpha: 1), for: UIControl.State.normal)
        ...
        self.doneButton.addTarget(self, action: #selector(PickerViewDialog.buttonTapped(sender:)), for: UIControl.Event.touchUpInside)
